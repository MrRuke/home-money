...
import { BillQuery } from '@app/old/system/shared/stores/bill/query';
import { CategoriesQuery } from '@app/old/system/shared/stores/categories/query';
import { EventsQuery } from '@app/old/system/shared/stores/events/query';
import {
  combineLatest,
  Observable,
} from 'rxjs';
